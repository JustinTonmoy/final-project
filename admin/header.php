  ...
  <div class="leftpanel">
    ...
    <div class="leftpanelinner">
      ...
      <ul class="nav nav-pills nav-stacked nav-bracket">
        ...
        <li><a href="customerview.php"><i class="fa fa-user"></i><span>View Customer</span></a></li>
       <li><a href="emaillist.php"><i class="fa fa-envelope"></i><span>View Messages</span></a></li>
        ...
        <li class="nav-parent"><a href="partview.php"><i class="fa fa-th-list"></i> <span>Measurement </span></a>
          <ul class="children">
             <li><a href="partview.php"><i class="fa fa-caret-right"></i>View Mesurement Parts</a></li>
          </ul>
        </li>
      </ul>
